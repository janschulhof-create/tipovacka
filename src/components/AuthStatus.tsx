...
export function AuthStatus({ player, className = '' }: { player: SessionPlayer | null; className?: string }) {
  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      <Link prefetch={false} href="/profil" className="flex items-center gap-1.5 rounded-lg bg-terrain-800 px-3 py-1.5 text-sm text-white transition hover:bg-terrain-700">
